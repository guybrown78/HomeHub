        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            ...
            <p className="mt-6 text-lg text-fg-muted">
              HomeHub helps landlords connect with hundreds of tenants —
              delivering energy advice, repair updates, local support, and
              trusted communication, all in one place.
            </p>
            <p className="mt-4 text-lg text-fg-muted">
              Be among the first to experience how HomeHub simplifies
              communication, support, and energy engagement across your homes.
            </p>
            <div className="mt-8 flex flex-wrap gap-x-6 gap-y-4">
              <KnowMoreLink />
              <Button href="#features" variant="outline">
                <span className="text-lg font-semibold pt-1">See Features</span>
              </Button>
            </div>
          </div>
