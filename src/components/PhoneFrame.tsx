...
export function PhoneFrame({
  ...
  return (
    <div className={clsx('relative aspect-366/729', className)} {...props}>
      ...
      <div className="absolute top-[calc(0/729*100%)] left-[calc(23/366*100%)] grid h-[calc(707/729*100%)] w-[calc(318/366*100%)] transform grid-cols-1 overflow-hidden pt-[calc(0/318*100%)]">
        {children}
      </div>
